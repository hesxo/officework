        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                NO.318/3 Sirimangala watta Road, Mampe, Piliyandala, Sri Lanka.
              </li>

              <li>
                <a href="tel:+94112724289" className="flex items-center gap-4.5 hover:text-blue">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:info@officeworks.lk" className="flex items-center gap-4.5 hover:text-blue">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/about-us">
                  About Us
                </a>
              </li>
              <li>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy;{year} www.officeworks.lk All Rights Reserved.
            </p>

...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Seth Products", value: "1" },
    { label: "Accessories", value: "2" },
    { label: "Board", value: "3" },
    { label: "Books", value: "4" },
    { label: "Computer Stationery", value: "5" },
    { label: "Filing And Storage", value: "6" },
    { label: "General Stationery", value: "7" },
    { label: "Office Stationery", value: "8" },
    { label: "Packaging Materials", value: "9" },
    { label: "Photocopy Papers", value: "10" },
    { label: "School Stationery", value: "11" },
  ];
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                ...
                <a href="tel:+94112724289" className="font-medium text-custom-sm text-dark hover:text-blue">
                  +94 11 2724289
                </a>
              </div>
            </div>
                ...
                <li className="py-4">
                  ...
                  >
                    <span className="inline-block relative">
                      ...
                      <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-blue w-4.5 h-4.5 rounded-full text-white min-w-[18px]">
                        {wishlistCount}
                      </span>
                    </span>
                    Wishlist

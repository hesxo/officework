  ...
  return (
    <div className="group">
      <div
        ...
        className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px] cursor-pointer"
      >
        ...
        <div className="flex justify-center items-center">
          <Image src={item.imgs?.previews?.[0] ?? "/images/products/product-new-01.jpg"} alt={item.title || ""} width={280} height={280} />
        </div>
